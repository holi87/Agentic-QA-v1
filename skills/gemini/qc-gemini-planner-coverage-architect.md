---
name: qc-gemini-planner-coverage-architect
...
# Skill: qc-gemini-planner-coverage-architect
...
- The reviewer skill `qc-gemini-reviewer-validate-tests` Hard rule #2
...
- Marker contract for downstream generators: see
  `qc-gemini-reviewer-validate-tests` step 12 (issue #233).
