---
name: qc-codex-planner-coverage-architect
...
# Skill: qc-codex-planner-coverage-architect
...
- The reviewer skill `qc-codex-reviewer-validate-tests` Hard rule #2
...
- Marker contract for downstream generators: see
  `qc-codex-reviewer-validate-tests` step 12 (issue #233).
